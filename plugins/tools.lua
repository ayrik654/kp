--Begin Tools.lua :)
local SUDO = 531876255 -- put Your ID here! <===
...
if ((matches[1] == 'KasperGuard' and not Clang) or (matches[1] == "کاسپر" and Clang)) then
...
if ((matches[1] == "slm kasper") or (matches[1] == "سلام کاسپر")) then
if msg.to.type == 'pv' then
return tdcli.sendMessage(msg.to.id, msg.id, 1,'<i>سلام دوست من .از این که به من پیام دادی سپاسگذارم.من فقط به پیغام های تعریف شده پاسخ میدم.شناسه ی عددی شما :</i><b>'..msg.to.id..'</b>', 1, 'html')
end
end
...
_Sudoer And Admins KasperGuard Bot Help :_
...
text = [[
_راهنمای ادمین و سودو های ربات کاسپر:_
